...
class Food101ProcessorConfig(VisionClassificationProcessorConfig):
    data_processor: Literal["Food101Processor"]
...
class Food101Processor(VisionClassificationProcessor):
    def __init__(self, config: Food101ProcessorConfig):
