...
class EuroSATProcessorConfig(VisionClassificationProcessorConfig):
    data_processor: Literal["EuroSATProcessor"]
...
class EuroSATProcessor(VisionClassificationProcessor):
    """RGB version of the EuroSAT Dataset (num channel = 3)"""

    def __init__(self, config: EuroSATProcessorConfig):
