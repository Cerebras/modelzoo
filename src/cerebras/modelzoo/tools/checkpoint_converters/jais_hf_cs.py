...
class Converter_JAISModel_WithoutModelPrefix_HF_CS20(
    Converter_GPT2Model_HF_CS17
):
    ...
    def converter_note(cls) -> str:
        return (
            "{} JaisModel <-> {} GPT2LMHeadModel (configured as Jais)\n"
    ...
    def get_config_converter_class() -> BaseConfigConverter:
        return ConfigConverter_JAISModel_HF_CS20

    def attempt_mup_to_sp(self) -> bool:
        return False


class Converter_JAISLMHeadModel_WithoutModelPrefix_HF_CS20(
    BaseCheckpointConverter_HF_CS
):
    def __init__(self):
        super().__init__()
        self.rules = [
            ...
            ConversionRule(
                [
                    ...
                    Converter_JAISModel_WithoutModelPrefix_HF_CS20(),
                ],
                action=None,
            ),
        ]
    ...
    @classmethod
    def converter_note(cls) -> str:
        return "{} JAISLMHeadModel <-> {} GPT2LMHeadModel (configured as JAIS)".format(
...
Converter_JAISModel_HF_CS20 = Build_HF_CS_Converter_WithOptionalModel(
    "Converter_JAISModel_HF_CS20",
    Converter_JAISModel_WithoutModelPrefix_HF_CS20,
    derived_class=Converter_JAISModel_WithoutModelPrefix_HF_CS20,
)


Converter_JAISLMHeadModel_HF_CS20 = Build_HF_CS_Converter_WithOptionalModel(
    "Converter_JAISLMHeadModel_HF_CS20",
    Converter_JAISLMHeadModel_WithoutModelPrefix_HF_CS20,
    derived_class=Converter_JAISLMHeadModel_WithoutModelPrefix_HF_CS20,
)


class ConfigConverter_JAISModel_HF_CS20(ConfigConverter_GPT2Model_HF_CS20):
    def __init__(self) -> None:
        super().__init__()
        self.rules = [
            ConversionRule(
                ["model_type"],
                action=BaseConfigConverter.assert_factory_fn(0, "jais"),
            ),
...
class Converter_JAISLMHeadModel_CS20_CS21(Converter_GPT2LMHeadModel_CS20_CS21):
    @classmethod
    def converter_note(cls) -> str:
        return "GPT2LMHeadModel class (configured as JAIS)"


class ConfigConverter_JAISModel_HF_CS21(ConfigConverter_JAISModel_HF_CS20):
    def __init__(self):
        super().__init__()
        self.rules = [
            ConversionRule(
...
class Converter_JAISModel_WithoutModelPrefix_HF_CS21(
    Converter_JAISModel_WithoutModelPrefix_HF_CS20
):
    def __init__(self):
        super().__init__()
    ...
    @staticmethod
    def get_config_converter_class() -> BaseConfigConverter:
        return ConfigConverter_JAISModel_HF_CS21


Converter_JAISModel_HF_CS21 = Build_HF_CS_Converter_WithOptionalModel(
    "Converter_JAISModel_HF_CS21",
    Converter_JAISModel_WithoutModelPrefix_HF_CS21,
    derived_class=Converter_JAISModel_WithoutModelPrefix_HF_CS21,
)


class Converter_JAISLMHeadModel_WithoutModelPrefix_HF_CS21(
    Converter_JAISLMHeadModel_WithoutModelPrefix_HF_CS20
):
    def __init__(self):
        super().__init__()
...
Converter_JAISLMHeadModel_HF_CS21 = Build_HF_CS_Converter_WithOptionalModel(
    "Converter_JAISLMHeadModel_HF_CS21",
    Converter_JAISLMHeadModel_WithoutModelPrefix_HF_CS21,
    derived_class=Converter_JAISLMHeadModel_WithoutModelPrefix_HF_CS21,
)
