...
from cerebras.modelzoo.models.nlp.dpr.embedding_generation.input.DPREmbedGenHDF5DataProcessor import (  # noqa
    DPREmbedGenHDF5DataProcessor,
)
from cerebras.modelzoo.data.internal.nlp.bert.BertSyntheticDataset import (  # noqa
