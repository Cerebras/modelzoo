...
from genentech_shared.bert.tf.fine_tuning.regression.input.FluorescenceDataProcessor import (  # noqa
    FluorescenceDataProcessor,
)
from genentech_shared.bert.tf.fine_tuning.regression.input.StabilityDataProcessor import (  # noqa
    StabilityDataProcessor,
)
...
def train_input_fn(params, input_context=None):
    return getattr(
        ...
        is_training=True, input_context=None
    )
...
def eval_input_fn(params, input_context=None):
    return getattr(
        ...
        is_training=False, input_context=None
    )
