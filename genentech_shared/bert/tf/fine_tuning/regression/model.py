...
from genentech_shared.bert.tf.fine_tuning.regression.BertRegressionModel import (
    BertRegressionModel,
)
...
def model_fn(features, labels, mode, params):
    ...
    """
    bert = BertRegressionModel(params)
    ...
    if bert.trainer.is_grad_accum():
        hooks = get_grad_accum_hooks(
            ...
            summary_dict={"train/cost_squared_error": total_loss},
