...
from singularity_dao_shared.spacetimeformer.tf.data import (
    eval_input_fn,
    train_input_fn,
)
from singularity_dao_shared.spacetimeformer.tf.model import model_fn
from singularity_dao_shared.spacetimeformer.tf.utils import (
...
def validate_params(params):
    ...
    if (
        ...
        assert runconfig_params["mode"] in [
            "train",
            "eval",
        ], "For Transformer model, only train and eval are supported on the Cerebras System."
