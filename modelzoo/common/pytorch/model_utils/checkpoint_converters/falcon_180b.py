...
class Converter_Falcon_180B_Headless_HF_CS20(
    ...
    def __init__(self):
        ...
        self.rules = [
            # Drop alibi slopes
            ConversionRule(
                [r"relative_pe_helper\.slopes"], exists="right", action=None,
            ),
...
class ConfigConverter_Falcon_180B_HF_CS20(BaseConfigConverter_HF_CS):
    def __init__(self):
        ...
        self.rules = [
            ...
            ConversionRule(["bias"], exists="left", action=self.convert_bias,),
            ConversionRule(
            ...
            ConversionRule(
                ["use_ffn_bias"], exists="right", action=self.convert_bias,
            ),
            ConversionRule(
                ["alibi"],
                exists="left",
