...
class Converter_MPTModel_HF_CS20(Converter_MPTModel_HF_CS):
    def __init__(self):
        ...
        self.rules = [
            ...
            ConversionRule([Converter_MPTModel_HF_CS(),], action=None,),
            # Catch checkpoints from deprecated PyTorchBaseModel
            ConversionRule(
                [EquivalentSubkey("", "model."), Converter_MPTModel_HF_CS(),],
                action=None,
            ),
        ]
...
class Converter_MPTForCausalLM_HF_CS20(Converter_MPTForCausalLM_HF_CS):
    def __init__(self):
        ...
        self.rules = [
            # Catch checkpoints from Pytorch 2.0 API
            ConversionRule([Converter_MPTForCausalLM_HF_CS(),], action=None,),
            # Catch checkpoints from deprecated PyTorchBaseModel
            ConversionRule(
                [
...
class ConfigConverter_MPT_HF_CS20(BaseConfigConverter_HF_CS):
    def __init__(self):
        ...
        self.rules = [
            ...
            ConversionRule(["norm_type"], action=self.convert_norm_type,),
            ConversionRule(
                ["embedding_fraction"],
