...
```
python modelzoo/vision/pytorch/unet/input/scripts/resize_skm_tea_files.py --input_dir <path to raw dataset> --output_dir <output dir path> --width <resized width> --height <resized height> --depth <resized depth>
```

## Data processors
The output dataset is to be used with (SkmDataProcessor)[../../SkmDataProcessor] which uses a iterable-style dataset.
