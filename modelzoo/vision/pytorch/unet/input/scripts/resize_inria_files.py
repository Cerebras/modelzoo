...
def apply_transform_to_files(
    ...
    for fname in image_names:
        ...
        transform_fn(
            img_in_path, img_out_path, width, height, is_lbl_transform=False,
        )
        ...
        if apply_transform_to_lbl:
            ...
            transform_fn(
                lbl_in_path, lbl_out_path, width, height, is_lbl_transform=True,
            )
...
def get_parser_args():
    ...
    parser.add_argument(
        "--input_dir", type=str, required=True, help="input image file dir",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
