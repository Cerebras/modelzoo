...
def create_features_auto_lm(
    ...
    Returns:
        Tuple containing features and labels and number of pad tokens
    """
    ...
    # number of pad tokens in addition to the original data.
    return (
...
class LMDataTokenGenerator:
    ...
    def process_chunks(
        ...
        Returns:
        Tuple[List[Any], int]: A tuple containing a list of processed results and the total number of padding tokens added.
        """
        ...
        for chunk in tokenized_text_chunks:
            ...
            processed, num_pad = create_features_auto_lm(
                chunk,
                self.max_seq_length,
            ...
            if processed != []:
                ...
                stats["num_masked_tokens"] += num_pad
                stats["loss_valid_tokens"] += self.max_seq_length - num_pad
    ...
    def tokenize_text_auto_lm(self, text: str) -> List[np.ndarray]:
        """
        ...
        Returns:
            List[np.ndarray]: Features created for auto-regressive language modeling.
        """
        # tokenize text
        if self.split_text_to_tokenize:
    ...
    def encode(self, data: str) -> List[np.ndarray]:
        """
        ...
        Returns:
            List[np.ndarray]: Encoded features for auto-regressive language modeling.
        """
    ...
    def encode_leftover_prefix(
        ...
        Returns:
            Tuple[List[np.ndarray], int]: A tuple containing the processed token chunks as
            a list of ndarrays and the number of padding tokens added.
        """
        tokenized_text_chunks = [
