...
from modelzoo.transformers.tf.t5.data import eval_input_fn, train_input_fn
from modelzoo.transformers.tf.t5.model import model_fn
from modelzoo.transformers.tf.t5.utils import (
...
def validate_params(params):
    ...
    if (
        ...
        assert runconfig_params["mode"] in [
            "train",
            "eval",
        ], "For T5 model, only train and eval are supported on the Cerebras System."
        assert not (
