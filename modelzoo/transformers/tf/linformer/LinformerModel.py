...
from modelzoo.transformers.tf.linformer.layers.Encoder import Encoder
from modelzoo.transformers.tf.transformer_utils import create_embedding_layers


class LinformerModel(TFBaseModel):
    """
    The Linformer model https://arxiv.org/pdf/2006.04768.pdf
    ...
    def __init__(self, params, encode_only=False):
        ...
        self.projected_dims = params["model"]["projected_dims"]
        self.attention_style = params["model"]["attention_style"]
    ...
    def build_model(self, features, mode):
        ...
        encoder_output = self.encoder(
            encoder_input, self_attention_mask=None, training=is_training,
        )
