...
from modelzoo.transformers.tf.bert.fine_tuning.qa.BertQuestionAnsweringModel import (
...
def model_fn(features, labels, mode, params):
    ...
    """
    bert = BertQuestionAnsweringModel(params)
    ...
    if mode == tf.estimator.ModeKeys.TRAIN:
        ...
        host_call = (bert.build_eval_metric_ops, [outputs, labels, features])
    ...
    if bert.trainer.is_grad_accum():
        hooks = get_grad_accum_hooks(
            ...
            summary_dict={"train/cost_qa": total_loss},
