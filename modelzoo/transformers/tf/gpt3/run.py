...
"""
Use this script for running on GPU.
"""
...
from modelzoo.transformers.tf.gpt2.utils import (
...
def create_arg_parser(default_model_dir):
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Number of steps after which we save summaries.",
    )
    parser.add_argument(
        "--save_checkpoints_steps",
        type=int,
        default=None,
        help="Number of steps after which we save a checkpoint.",
    )
    parser.add_argument(
        "--eval_steps",
        type=int,
